...
# Import NAHL client
from backends.nahl_client import NAHLClient
# Optional DRAKON HTTP API client (fast fuzzy search)
DrakonHTTPClient = None
try:
    from backends.game_lookup_drakon import DrakonClient as _DrakonClient
...
class GameLookup:
    ...
    def __init__(self, config: dict):
        ...
        from backends.providers import SteamProvider, IGDBProvider, RAWGProvider
        self.providers = []
